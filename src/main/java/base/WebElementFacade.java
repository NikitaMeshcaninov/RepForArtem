...
public class WebElementFacade implements WrapsElement, WebElement, Locatable {
     ...
     *
     * @param value which you want to set up in the text area or input and then sen key ENTER
     */
    ...
    public WebElementFacade selectAutocomplete(final String value) {
        waitUntilElementAvailable();
        clear();
        getElement().sendKeys(value, Keys.ARROW_DOWN, Keys.ENTER);
        return this;
    }
     ...
     *
     * @param value which you want to setup to the text area or input. an then click TAB
     */
    ...
    public WebElementFacade selectByVisibleText(final String label) {
        waitUntilElementAvailable();
        Select select = new CustomSelect(getElement(), driver);
    ...
    public boolean containsAttribute(String attribute) {
        waitUntilVisible();
        return getElement().getAttribute(attribute) != null;
    }
